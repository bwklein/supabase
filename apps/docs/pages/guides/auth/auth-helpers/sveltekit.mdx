...
```bash
# Install supabase node.js CLI
npm install supabase
# Authenticate to your supabase project, requires an Access Token from Supabase.
npx supabase login
# Requires your Supabase Project ID String and a 'types' folder in your root directory.
npx supabase gen types typescript --project-id "$PROJECT_ID" --schema public > src/DatabaseDefinitions
```
